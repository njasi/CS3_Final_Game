...
LIBS = $(LIB_MATH) -lSDL2 -lSDL2_gfx -lSDL2_ttf -lSDL2_image -lSDL2_mixer #_AUDIO_

# List of demo programs
DEMOS = bounce gravity pacman nbodies damping spaceinvaders breakout pegs echo \
	ip castlebreaker
# List of C files in "libraries" that we provide
STAFF_LIBS = test_util sdl_wrapper tileset
# List of C files in "libraries" that you will write
STUDENT_LIBS = vector polygon list \
	color body scene \
	forces network_util network_engine 
...
bin/%: out/demo-%.o out/sdl_wrapper.o out/tileset.o $(STUDENT_OBJS)
	$(CC) $(CFLAGS) $(LIBS) $^ -o $@
